...
// Generic "no items yet" placeholder for list pages. Optional icon (lucide)
// + message + optional action button. Muted styling so it doesn't pull
// attention away from primary surfaces.
