...
// Two-state toggle: light ↔ dark only (no "system"). Icon reflects the NEXT
// theme so the affordance reads as "switch to X". Same component as PWA so
// the two apps share one mental model.
